...
Goal: get the user from "I have Claude Code installed" to a working OpenGA workspace with the review app running.
...
8. After the clone, the project-level `CLAUDE.md` / `AGENTS.md` and the skills in `.claude/skills/` and `.agents/skills/` take over.
