...
/-- **Math.** **Local Lipschitz property at a point of the chart-target interior product.**
...
/-- **Math.** **Local Lipschitz property on a compact subset of the chart-target interior
...
/-- **Math.** **Existence of a global Lipschitz constant on a compact spatial set.**
...
/-- **Math.** **Uniform-in-parameter chart-coordinate ODE uniqueness on
...
/-- **Math.** **Uniform agreement of a chart-phase solution with the chart-pushed
...
/-- **Math.** **Uniform-in-parameter ODE uniqueness on a closed ball.** Specialised
