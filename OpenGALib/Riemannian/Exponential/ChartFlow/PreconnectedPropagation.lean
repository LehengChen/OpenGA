...
/-- **Math.** **Maximal-geodesic witness packaging from a Picard–Lindelöf lift.**
...
/-- **Math.** **Clopen propagation of equality of two integral curves on a
...
/-- **Math.** **Pointwise identification on the witness interval.** At any
...
/-- **Math.** **Eventually-near-`0` identification of the manifold lift's
...
/-- **Math.** **Headline R.D.2 — projection of the manifold lift equals the
